...
\begin{figure}[tb!]
  \centering
  \subfloat{\includegraphics[width=.5\textwidth]{ave_sum_rule_saturation_ph_pairs.pdf}}
  \subfloat{\includegraphics[width=.5\textwidth]{no_states_ph_pairs.pdf}}\\
  \subfloat{\includegraphics[width=.5\textwidth]{ave_form_factor_ph_pairs.pdf}}
\end{figure}

\begin{figure}[tb!]
  \centering
   \subfloat{\includegraphics[width=.5\textwidth]{saturations_over_states.pdf}}
   \subfloat{\includegraphics[width=.5\textwidth]{saturations_over_momenta.pdf}}\\
\end{figure}



With \(N = 5\), \(I_{\max}=12\) we have a total sumrule saturation of approximatly 83.5\%.
