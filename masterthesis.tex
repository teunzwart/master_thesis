...
It should be note that ABACUS because ABACUS can scan within momentum slices, uniformly high saturations can be achieved \(\cref{fig:abacus_saturations_12_5}\).
