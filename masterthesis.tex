...
Therefore \(\lambda-\lambda_p\) always has the opposite sign from~\(\lambda_p\).\todo{Check that this is true!}
...
Note that the learning is all tabula arse reinforcement learning
