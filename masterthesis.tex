...
These linear combinations are then transformed with a differentiable, nonlinear activation function \(h(a_j)\).
The nonlinearity is key here, because it allows the system to act as a general function approximator.
...
\begin{align}
  \label{eq:72}
  \delta_j = \pdv{h(a_j)}{a_j} \sum_k w_{kj} \delta_k.
\end{align}
...
F. Chollet etal., \emph{Keras}, \href{https://keras.io}{https://keras.io} (2015).
