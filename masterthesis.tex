...
This linear can be solved using LU decomposition~\cite{Press2007} (see \cref{app:ludecomp}).
...
We see both that some highly contributing form factors are missed early on, appearing as spike in the distribution later, as well as see small form factors spurrioulsy being considered early, resulting in wasted computations.
...
For the density-density correlator of the Lieb-Liniger model this becomes
\begin{align}
