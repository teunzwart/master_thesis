...
As an approximate measure of the average size of matrix elements, we consider a linear trendline trough the data.\todo{Redo with log mean, to account for wide range of possible values.}
